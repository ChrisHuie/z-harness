...
FIXTURES = [
    ...
    ("RED  WRAPPER: underscore-escaped separators still expose the outer zsh modifier",
     "SHA=x; env -S \"git\\_show\\_$SHA:src/f.py\"", "deny"),
    ("GREEN WRAPPER: the same separators in a literal source stay clean",
     "SHA=x; env -S 'git\\_show\\_$SHA:src/f.py'", "allow"),
