...
SELFTEST_SUITES = [
    ("bash_command_guard", ["hooks/bash_command_guard.py", "--selftest"], 1088),
    ...
    ("ci-gate", ["tools/ci-gate.py", "--selftest"], 28),
    ...
    ("git_grep_engine_guard", ["hooks/guards/git_grep_engine_guard.py", "--selftest"], 571),
