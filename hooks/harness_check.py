...
SELFTEST_SUITES = [
    ("bash_command_guard", ["hooks/bash_command_guard.py", "--selftest"], 776),
    ...
    ("git_grep_engine_guard", ["hooks/guards/git_grep_engine_guard.py", "--selftest"], 445),
    ("zsh_rev_modifier_guard", ["hooks/guards/zsh_rev_modifier_guard.py", "--selftest"], 181),
]
