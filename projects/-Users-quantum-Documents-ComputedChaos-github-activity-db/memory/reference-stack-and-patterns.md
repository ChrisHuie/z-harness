---
name: reference-stack-and-patterns
description: Stack, nested-JSON pattern, test factories, migrations and known gotchas for this repo
metadata:
  type: reference
---

# Stack, patterns and gotchas
