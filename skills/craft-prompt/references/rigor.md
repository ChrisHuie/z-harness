...
Lint hooks: R2+ output containing unhedged claims without citations; unsupported optimism or probability filler in R3 outputs. Rubric hooks: grounding rate of load-bearing claims; presence of explicit insufficiency statements when material is thin.
